...
message.channel.send(new MessageEmbed().setColor('0x348f36').setDescription(`${message.author} Sana ait sicil verileri başarıyla silindi!`))
message.react('Mesaj Tepki ID')
}
  
if(member) {
let sicil = kdb.delete(`kullanici.${member.id}.sicil`) || [];
message.channel.send(new MessageEmbed().setColor('0x348f36').setDescription(`${member} Kullanıcısına ait sicil verileri başarıyla silindi!`))
message.react('Mesaj Tepki ID')
